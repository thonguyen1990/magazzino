        ...
        <b-col>
          ...
          >
            <label
              ...
              v-bind:class="{ active: materialeTutto }"
            >
              <input
                type="radio"
                ...
                id="materialeTutto"
                autocomplete="off"
                @click="filtroMateriale('tutto')"
              />Tutto
            </label>
            <label
              class="btn btn-outline-primary"
              v-bind:class="{ active: ob }"
            >
              <input
                type="radio"
                name="options_materiale"
                id="ob"
                autocomplete="off"
                @click="filtroMateriale('ob')"
              />Oro Bianco
            </label>
            <label
              class="btn btn-outline-primary"
              v-bind:class="{ active: or }"
            >
              <input
                type="radio"
                name="options_materiale"
                id="or"
                autocomplete="off"
                @click="filtroMateriale('or')"
              />Oro Rosa
            </label>
            <label
              class="btn btn-outline-primary"
              v-bind:class="{ active: tit }"
            >
              <input
                type="radio"
                name="options_materiale"
          ...
          >
            ...
            >
              <input
                ...
                id="orecchini"
                autocomplete="off"
                @click="filtroTipo('orecchini')"
              />ORECCHINI
            </label>
            <label
              class="btn btn-outline-primary"
              v-bind:class="{ active: bracciali }"
            >
              <input
                type="radio"
                name="options_categoria2"
      ...
      >
        <template #cell(img)="data">
          <img
            v-if="data.value"
            v-img
            :src="data.value + '?' + $session.get('secret')"
            alt="Pietra image"
            img-top
          />
        </template>
