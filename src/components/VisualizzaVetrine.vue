  ...
  <b-container fluid>
    ...
    <b-table striped hover :fields="fields" :items="vetrine">
      ...
      <template #cell(azione)="row">
        <b-button size="sm" class="mr-1" @click="modificaVetrina(row.item)"
          >Modifica</b-button
        >
        <b-button
          size="sm"
    ...
    >
      <div class="insideWrapper" id="canvas-wrapper">
        <b-img
          :src="inModifica.img + '?' + $session.get('secret') + '&' + timestamp"
          fluid
          @load="creaCanvas"
          id="immagineVetrina"
        ></b-img>
    ...
    <b-modal id="modal-nuova" hide-footer :title="'NUOVA VETRINA'">
      <b-form inline>
