    ...
    <b-navbar toggleable="lg" type="dark" variant="dark" class="navbar-admin">
            ...
            <b-navbar-nav class="left-agenda">
                ...
                <b-nav-item-dropdown href="#" to="/adminProducts">
                    <template #button-content>
                        <span @click="vai('/adminProducts')"><span
                                :style="{ 'color': getActiveRoute('/adminProducts') }">PRODOTTI<span><span><b-icon
                                            icon="caret-down-fill" style="margin-left: 0.2rem;"
                ...
                <b-nav-item-dropdown href="#" class="pietre-split">
                    <template #button-content>
                        <span><span style="color:white">PIETRE<span><span><b-icon icon="caret-down-fill"
                ...
                <b-nav-item-dropdown href="#" class="lavorazioni-split">
                    <template #button-content>
                        <span @click="vai('/riparazioni/TUTTO')"><span style="color:white">LAVORAZIONI<span><span><b-icon
                                            icon="caret-down-fill" style="margin-left: 0.2rem;"
                                            font-scale="0.8"></b-icon></span></span></span></span>
                    </template>
                ...
                <b-nav-item href="#" to="/laboratorio" class="lab-split"><span
                        :style="{ 'color': getActiveRoute('/laboratorio') }">LAB</span></b-nav-item>
                <b-nav-item-dropdown href="#" class="client-split">
                    <template #button-content>
                        <span @click="vai('/clienti/NO')"><span style="color:white">CLIENTI<span><span><b-icon
                                            icon="caret-down-fill" style="margin-left: 0.2rem;"
                                            font-scale="0.8"></b-icon></span></span></span></span>
                    </template>
                    <b-dropdown-item href="#" to="/clienti/PROMEMORIA">PROMEMORIA</b-dropdown-item>
                    <b-dropdown-item
                        v-if="this.$session.exists() && (this.$session.get('AUTORIZZAZIONI').elenco_visite_vendite >= 1)"
                        href="#" to="/statsVV">VISITE & VENDITE</b-dropdown-item>
        ...
        <b-nav-item href="#" to="/conti"><span style="color:white">CONTI</span></b-nav-item>-->
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-navbar-brand to="/split-vue"><b-icon icon="layout-split" font-scale="1"></b-icon></b-navbar-brand>
                <b-navbar-brand to="/"><b-icon icon="shop" font-scale="1"></b-icon></b-navbar-brand>
                ...
                <b-navbar-brand right v-if="this.$session.exists()" href="#" to="/gestioneDB"><span
                        style="color: whitesmoke;"><b-icon icon="tools" font-scale="1"></b-icon></span></b-navbar-brand>


                <b-navbar-brand right v-if="this.$session.exists()" href="#" to="/logout"><span
                        style="color: whitesmoke;"><b-icon icon="door-closed"
                            font-scale="1"></b-icon></span></b-navbar-brand>
            </b-navbar-nav>
        </b-collapse>
    </b-navbar>
</template>
