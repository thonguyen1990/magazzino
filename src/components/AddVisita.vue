    ...
    <b-form @submit="onSubmitNuovaVisita">
      ...
      <b-row>
        <b-col>
          <b-form-group label="Cliente:" label-for="input-cliene">
            <model-select
              ...
              onchange="clienteSelezionato()"
              v-model="formNuovaVisita.idCliente"
        ...
        <b-col>
          <b-form-group label="Data Visita" label-for="input-dataVendita">
            <b-form-datepicker
              id="input-dataVendita"
              today-button
              reset-button
              v-model="formNuovaVisita.dataVisita"
              class="mb-2"
            ></b-form-datepicker>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Ora Visita" label-for="input-oraVendita">
            <model-select
              id="input-oraVendita"
              class="form-control"
              v-model="formNuovaVisita.oraVisita"
              :options="optionsOra"
              placeholder="Seleziona l'ora di visita"
            ></model-select>
          </b-form-group>
        </b-col>
      </b-row>
        ...
        <b-col>
          ...
          >
            <b-form-input
              ...
              v-model="formNuovaVisita.fonte_dettaglio"
              type="text"
            ></b-form-input>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Gift:" label-for="input-dettaglioFonte">
            <b-form-checkbox
              ...
              v-model="formNuovaVisita.gift"
              name="input-tag"
              id="input-tag"
              switch
            >
              <span v-if="formNuovaVisita.gift == 1"
                ><b-icon
                  icon="gift-fill"
                  variant="success"
                  font-scale="1.5"
        ...
        <b-col>
          <div class="form-group">
            <div class="align-left">
              <label class="prodottoVenditaN">PRODOTTO 1 </label>
              <span
                style="color: red; margin-left: 2em; font-weight: bold"
                @click="clearProdotto(1)"
                >X</span
              >
            </div>
            <model-select
              ...
              v-model="formNuovaVisita.prodotto1"
              @input="getPrezzoProdotto(formNuovaVisita.prodotto1, 1)"
              placeholder="Seleziona il prodotto"
            ></model-select>
            <b-form-input
              id="input-custom1"
              v-model="formNuovaVisita.custom1"
              type="text"
              v-if="formNuovaVisita.prodotto1 == 0"
            ></b-form-input>
          </div>
        </b-col>
        <b-col>
          <b-form-group label="Pr.Listino:" label-for="input-p1">
            <b-form-input
              ...
              id="input-p1"
              v-model="formNuovaVisita.prezzo1"
              type="number"
              step=".01"
            ></b-form-input>
          </b-form-group>
        ...
        <b-col>
          <b-form-group label="Pr.Scontato:" label-for="input-ps1">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-ps1"
              v-model="formNuovaVisita.prezzoSc1"
              v-on:keyup="calcPercSconto(1)"
              type="number"
              step=".01"
            ></b-form-input>
          </b-form-group>
        ...
        <b-col>
          <b-form-group label="Sconto (%):" label-for="input-sconto1">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-sconto1"
              v-model="formNuovaVisita.sconto1"
              v-on:keyup="calcPrezzoSconto(1)"
              type="number"
              step="0.01"
            ></b-form-input>
          </b-form-group>
      ...
      <b-row>
        <b-col>
          <b-form-group label="Categoria:" label-for="input-cat1">
            <model-select
              ...
              id="input-cat1"
              :options="optionsCat"
              v-model="formNuovaVisita.cat1"
              placeholder="Seleziona la categorie"
            ></model-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Tipologia:" label-for="input-catBis1">
            <model-select
              class="form-control"
              id="input-catBis1"
              :options="optionsCatBis"
              v-model="formNuovaVisita.catBis1"
              placeholder="Seleziona la categorie"
            ></model-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="SottoCategoria:" label-for="input-sottocat1">
            <b-form-input
              id="input-sottocat1"
              v-model="formNuovaVisita.sottocat1"
              type="text"
            ></b-form-input>
          </b-form-group>
        </b-col>
        ...
        <b-col>
          <b-form-group label="Vetrina:" label-for="input-vetrina1">
            <model-select
              class="form-control"
              id="input-vetrina1"
              :options="optionsVetrina"
              v-model="formNuovaVisita.vetrina1"
              placeholder="Seleziona la vetrina"
            ></model-select>
          </b-form-group>
        </b-col>
      </b-row>
      ...
      <b-row>
        <b-col>
          <div class="form-group">
            <div class="align-left">
              <label class="prodottoVenditaN">PRODOTTO 2 </label>
              <span
                style="color: red; margin-left: 2em; font-weight: bold"
                @click="clearProdotto(2)"
                >X</span
              >
            </div>
            <model-select
              class="form-control"
              :options="optionsProdotti"
              v-model="formNuovaVisita.prodotto2"
              @input="getPrezzoProdotto(formNuovaVisita.prodotto2, 2)"
              placeholder="Seleziona il prodotto"
            ></model-select>
            <b-form-input
              id="input-custom2"
              v-model="formNuovaVisita.custom2"
              type="text"
              v-if="formNuovaVisita.prodotto2 == 0"
            ></b-form-input>
          </div>
        </b-col>
        <b-col>
          <b-form-group label="Pr.Listino:" label-for="input-p2">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-p2"
              v-model="formNuovaVisita.prezzo2"
              type="number"
              step=".01"
            ></b-form-input>
          </b-form-group>
        ...
        <b-col>
          <b-form-group label="Pr.Scontato:" label-for="input-ps2">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-ps2"
              v-model="formNuovaVisita.prezzoSc2"
              v-on:keyup="calcPercSconto(2)"
              type="number"
              step=".01"
            ></b-form-input>
          </b-form-group>
        ...
        <b-col>
          <b-form-group label="Sconto (%):" label-for="input-sconto2">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-sconto2"
              v-model="formNuovaVisita.sconto2"
              v-on:keyup="calcPrezzoSconto(2)"
              type="number"
              step="0.01"
            ></b-form-input>
          </b-form-group>
      ...
      <b-row>
        ...
        <b-col>
          <b-form-group label="Tipologia:" label-for="input-catBis2">
            <model-select
              ...
              id="input-catBis2"
              :options="optionsCatBis"
              v-model="formNuovaVisita.catBis2"
              placeholder="Seleziona la categorie"
            ></model-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="SottoCategoria:" label-for="input-sottocat2">
            <b-form-input
              id="input-sottocat2"
              v-model="formNuovaVisita.sottocat2"
              type="text"
            ></b-form-input>
          </b-form-group>
        </b-col>
        ...
        <b-col>
          <b-form-group label="Vetrina:" label-for="input-vetrina2">
            <model-select
              ...
              id="input-vetrina2"
              :options="optionsVetrina"
              v-model="formNuovaVisita.vetrina2"
              placeholder="Seleziona la vetrina"
            ></model-select>
          </b-form-group>
        </b-col>
      ...
      <b-row>
        <b-col>
          <div class="form-group">
            <div class="align-left">
              <label class="prodottoVenditaN">PRODOTTO 3 </label>
              <span
                style="color: red; margin-left: 2em; font-weight: bold"
                @click="clearProdotto(3)"
                >X</span
              >
            </div>
            <model-select
              class="form-control"
              :options="optionsProdotti"
              v-model="formNuovaVisita.prodotto3"
              @input="getPrezzoProdotto(formNuovaVisita.prodotto3, 3)"
              placeholder="Seleziona il prodotto"
            ></model-select>
            <b-form-input
              id="input-custom3"
              v-model="formNuovaVisita.custom3"
              type="text"
              v-if="formNuovaVisita.prodotto3 == 0"
            ></b-form-input>
          </div>
        </b-col>
        <b-col>
          <b-form-group label="Pr.Listino:" label-for="input-p3">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-p3"
              v-model="formNuovaVisita.prezzo3"
              type="number"
              step=".01"
            ></b-form-input>
          </b-form-group>
        ...
        <b-col>
          <b-form-group label="Pr.Scontato:" label-for="input-ps3">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-ps3"
              v-model="formNuovaVisita.prezzoSc3"
              v-on:keyup="calcPercSconto(3)"
              type="number"
              step=".01"
            ></b-form-input>
          </b-form-group>
        ...
        <b-col>
          <b-form-group label="Sconto (%):" label-for="input-sconto3">
            <b-form-input
              @focus.native="$event.target.select()"
              id="input-sconto3"
              v-model="formNuovaVisita.sconto3"
              v-on:keyup="calcPrezzoSconto(3)"
              type="number"
              step="0.01"
            ></b-form-input>
          </b-form-group>
      ...
      <b-row>
        ...
        <b-col>
          <b-form-group label="Tipologia:" label-for="input-catBis3">
            <model-select
              ...
              id="input-catBis3"
              :options="optionsCatBis"
              v-model="formNuovaVisita.catBis3"
              placeholder="Seleziona la categorie"
            ></model-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="SottoCategoria:" label-for="input-sottocat3">
            <b-form-input
              id="input-sottocat3"
              v-model="formNuovaVisita.sottocat3"
              type="text"
            ></b-form-input>
          </b-form-group>
        </b-col>
        ...
        <b-col>
          <b-form-group label="Vetrina:" label-for="input-vetrina3">
            <model-select
              ...
              id="input-vetrina3"
              :options="optionsVetrina"
              v-model="formNuovaVisita.vetrina3"
              placeholder="Seleziona la vetrina"
            ></model-select>
          </b-form-group>
        </b-col>
      ...
      <div class="form-group">
        <div class="container">
          <div class="row">
            <div class="col-8">
              <textarea
                placeholder="Inserisci una nota relativa alla visita"
                class="form-control"
                id="note"
                v-model="formNuovaVisita.note"
                rows="3"
              ></textarea>
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      optionsCatBis: [
        { value: "Anelli", text: "Anelli" },
        { value: "Braccialetti", text: "Braccialetti" },
        { value: "Ciondoli", text: "Ciondoli" },
        { value: "Collane", text: "Collane" },
        { value: "Orecchini", text: "Orecchini" },
        { value: "Altro", text: "Altro" },
      ],
      clienti: [],
      prodotti: [],
  ...
  methods: {
      ...
      axios
        .get(
          this.$store.state.settings.URL_SERVER +
            "API/v1.php?categorieLivello=2&thumb=medium&genitore=22"
        )
        .then((response) => {
    ...
    calcPercSconto(n) {
      switch (n) {
        case 1:
          this.formNuovaVisita.sconto1 = (
            (1 -
              parseFloat(this.formNuovaVisita.prezzoSc1) /
                parseFloat(this.formNuovaVisita.prezzo1)) *
            100
          ).toFixed(2);
          break;
        case 2:
          this.formNuovaVisita.sconto2 = (
            (1 -
              parseFloat(this.formNuovaVisita.prezzoSc2) /
                parseFloat(this.formNuovaVisita.prezzo2)) *
            100
          ).toFixed(2);
          break;
        case 3:
          this.formNuovaVisita.sconto3 = (
            (1 -
              parseFloat(this.formNuovaVisita.prezzoSc3) /
                parseFloat(this.formNuovaVisita.prezzo3)) *
            100
          ).toFixed(2);
          break;
      }
    ...
    calcPrezzoSconto(n) {
      switch (n) {
        case 1:
          this.formNuovaVisita.prezzoSc1 = (
            parseFloat(this.formNuovaVisita.prezzo1) *
            (1 - this.formNuovaVisita.sconto1 / 100)
          ).toFixed(2);
          break;
        case 2:
          this.formNuovaVisita.prezzoSc2 = (
            parseFloat(this.formNuovaVisita.prezzo2) *
            (1 - this.formNuovaVisita.sconto2 / 100)
          ).toFixed(2);
          break;
        case 3:
          this.formNuovaVisita.prezzoSc3 = (
            parseFloat(this.formNuovaVisita.prezzo3) *
            (1 - this.formNuovaVisita.sconto3 / 100)
          ).toFixed(2);
          break;
      }
    },
    ...
    getVisita(id) {
      axios
        ...
        .then((response) => {
          ...
          this.formNuovaVisita.fonte_dettaglio =
            this.visitaVendita.fonte_dettaglio;
          ...
          this.formNuovaVisita.oraVisita = parseInt(
            this.visitaVendita.oraVisita
          );
          this.$bvModal.show("modal-nuovaVisita");
        })
        .catch((err) => {
    ...
    onSubmitNuovaVisita() {
      ...
      axios
        .post(
          ...
          this.toFormData(this.formNuovaVisita),
          {
            headers: {
