      ...
      <b-navbar class="navmenu navbar-custom" toggleable="lg">
        ...
        <b-collapse id="nav-collapse" is-nav style="padding: 0.5rem">
          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-form>
              <b-navbar-brand to="/note" class="pencil-split"
                ><span class="itemNB"
                  ><b-icon icon="pencil-square" font-scale="1.3"></b-icon></span
              ></b-navbar-brand>
              <b-navbar-brand to="/nuoviarrivi" class="clock-split"
                ><span class="itemNB"
              ...
              <b-icon
                ...
                class="calculator-split"
              ></b-icon>
              <Calculator v-if="calc"></Calculator>
              <b-navbar-brand
                v-if="goldPrice"
                class="gold-price-split"
