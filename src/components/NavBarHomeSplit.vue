<template>
  <div class="split-main-div d-flex w-100">
    <b-navbar class="navmenu navbar-custom" toggleable="lg" > <b-img  :src="require('../assets/soloLogo_b.png')"  fluid alt="Responsive image" width=16></b-img>
      <b-navbar-brand class="navitem-custom" to="/"><span class="itemNB ms-1">HOME</span></b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
          ...
          <b-navbar-nav class="ml-auto">
              <b-nav-form>
                  ...
                  <b-b-nav-item   to="/favoriti"><span class="itemNB"><b-icon  style="margin-right:1em"  icon="heart-fill"  font-scale="1.3" ></b-icon></span></b-b-nav-item>
                  <b-b-nav-item   to="/note"><span class="itemNB"><b-icon  style="margin-right:1em"  icon="pencil-square"  font-scale="1.3" ></b-icon></span></b-b-nav-item>
                  <b-b-nav-item   to="/nuoviarrivi" class="mr-2"><span class="itemNB"><b-icon  icon="clock"  font-scale="1.3" ></b-icon></span></b-b-nav-item>

                  <b-button v-b-modal.modal-filtro size="sm" class="">
                      <b-icon  icon="funnel-fill"  font-scale="1.3" ></b-icon>
                      <span class="buttonNB">{{this.altriFiltri}}</span
                  ></b-button>
                  <div class="ml-1 mr-1">{{this.prezzoTxt}} <span v-if="this.prezzoTxt!=''" ><br></span>{{this.carTxt}}</div>
                  <b-form-input size="sm" class="mr-sm-2" placeholder="Cerca un prodotto" v-model="prodotto">
              </b-form-input>
              <b-button
              size="sm"
              class="my-1  buttonNB"
          ...
          <b-b-nav-item   to="/agenda"><b-icon  icon="gear-fill"  font-scale="1.3" style="margin-left:2em;"></b-icon></b-b-nav-item>
          <b-b-nav-item class="navitem-custom">
              
              <span class="itemNB">
              <b-icon  style="margin-right:1em"  icon="calculator"  font-scale="1.3" @click="toggleCalCulator()" ></b-icon>

              <Calculator v-if="calc" ></Calculator>
              <!-- <VueInputCalculator enableKeyboard v-model="calc">
                  <b-icon  style="margin-right:1em"  icon="calculator"  font-scale="1.3" ></b-icon>
              </VueInputCalculator> -->
              </span>
          </b-b-nav-item>
