    ...
    <b-collapse id="nav-collapse" is-nav class="agenda-show">
      <b-navbar-nav class="left-agenda">
        ...
        <b-nav-item-dropdown href="#" to="/adminProducts">
          <template #button-content>
            <span @click="vai('/adminProducts')"><span
                :style="{ 'color': getActiveRoute('/adminProducts') }">PRODOTTI<span><span><b-icon icon="caret-down-fill"
                      style="margin-left: 0.2rem;" font-scale="0.8"></b-icon></span></span></span></span>
          </template>
        ...
        <b-nav-item-dropdown href="#">
          <template #button-content>
            <span><span style="color:white">PIETRE<span><span><b-icon icon="caret-down-fill" style="margin-left: 0.2rem;"
        ...
        <b-nav-item href="#" to="/laboratorio"><span
        ...
        <b-nav-item-dropdown href="#">
          <template #button-content>
            <span @click="vai('/clienti/NO')"><span style="color:white">CLIENTI<span><span><b-icon icon="caret-down-fill"
                      style="margin-left: 0.2rem;" font-scale="0.8"></b-icon></span></span></span></span>
          </template>
          <b-dropdown-item href="#" to="/clienti/PROMEMORIA">PROMEMORIA</b-dropdown-item>
          <b-dropdown-item
            v-if="this.$session.exists() && (this.$session.get('AUTORIZZAZIONI').elenco_visite_vendite >= 1)" href="#"
            to="/statsVV">VISITE & VENDITE</b-dropdown-item>
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-navbar-brand to="/"><b-icon icon="shop" font-scale="1" style="margin-left: 2rem;"></b-icon></b-navbar-brand>
