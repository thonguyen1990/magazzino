  ...
  <b-container>
    <b-col>
      <div class="mx-auto mb-3 mt-1">
        <b-button v-b-modal.modal-nuovoCliente @click="clearFormNuovoCliente()"
      ...
      <table-component :data="clienti" size="xl">
        ...
        <table-column header-class="w-5" label="-">
          <template slot-scope="row">
            <a @click="modificaCliente(row)">Modifica</a> |
            <a @click="eliminaCliente(row.id)">Elimina</a>
          </template>
        </table-column>
      </table-component>
    </b-col>
