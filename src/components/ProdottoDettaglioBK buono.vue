...
<b-row  style="background-color:blue;height:100%">
  ...
  <b-col style="background-color:yellow;height:100%" >
    <b-row>
      <b-col>
        <div @click="isVisibile.dettagli=!isVisibile.dettagli" class="titoliSezioniPagProd">Dettagli
        ...
        <b-collapse :visible="isVisibile.collezione">
          <div>
            <div class="col d-flex justify-content-center">
              <div class="mt-auto mb-auto">
                <div class="txDettaglioTitolo">
                  {{prodotti[0].descrizione2}} <!-- modificare con descrizione collezione!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1-->
                </div>
              </div>
            </div>
          </div>
        ...
        <b-collapse :visible="isVisibile.altreCategorie">
          <div>
            <div class="col d-flex justify-content-center">
              <div class="mt-auto mb-auto">
                <div class="col">
                  <span v-bind:key="categoria.index" v-for="categoria in prodotti[0].categorie" class="txDettaglioCategoria">{{categoria.nomeCat}}</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="col d-flex justify-content-center">
      <div class="mt-auto mb-auto">
        <div class="col">
          <b-img  :src="require('../assets/daverio_bianco.jpeg')"  fluid alt="Responsive image" width=150 ></b-img>
        </div>
      </div>
    </div>
