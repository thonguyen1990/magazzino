          ...
          >
            ...
            >
              <input
                ...
                id="fedine"
                autocomplete="off"
                @click="filtroTipo('fedine')"
              />FEDINE
            </label>
            <label
              class="btn btn-outline-primary"
              v-bind:class="{ active: anelliSolitari }"
            >
              <input
                type="radio"
                name="options_categoria2"
                id="anelliSolitari"
                autocomplete="off"
                @click="filtroTipo('anelliSolitari')"
              />ANELLI SOLITARI
            </label>
            <label
              class="btn btn-outline-primary"
              v-bind:class="{ active: tennis }"
            >
              <input
                type="radio"
                name="options_categoria2"
