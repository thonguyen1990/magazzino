      ...
      <b-collapse id="nav-collapse" is-nav style="padding: 0.5rem; width: 100%;">
        ...
        <b-nav-item-dropdown href="#" style="display: flex; width: 5rem;">
          <template #button-content>
            <span><span class="itemNB"><b-icon icon="gem" font-scale="1.3"></b-icon><span><span><b-icon
                      icon="caret-down-fill" font-scale="0.8"></b-icon></span></span></span></span>
          </template>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-form>
            ...
            <!-- <b-navbar-brand to="/favoriti"><span class="itemNB"><b-icon style="margin-right:1em" icon="heart-fill"
                  font-scale="1.3"></b-icon></span></b-navbar-brand> -->
            <b-navbar-brand to="/note"><span class="itemNB pencil"><b-icon style="margin-right:1em" icon="pencil-square"
                  font-scale="1.3"></b-icon></span></b-navbar-brand>
            <b-navbar-brand to="/nuoviarrivi"><span class="itemNB clock"><b-icon icon="clock" style="margin-right:1em"
                  font-scale="1.3"></b-icon></span></b-navbar-brand>

            <b-icon style="color: whitesmoke; margin-right: 1rem;" icon="calculator" font-scale="1.3"
              @click="toggleCalCulator()" class="calculator"></b-icon>
            <Calculator v-if="calc"></Calculator>
            <b-navbar-brand v-if="goldPrice" style="color:whitesmoke" class="gold-price">{{ goldPrice }}
              €/gr</b-navbar-brand>
            <b-navbar-brand v-else="goldPrice" style="color: whitesmoke" class="gold-price">0 €/gr</b-navbar-brand>
            ...
            <!-- <b-button v-b-modal.modal-filtro size="sm" class=""><span class="buttonNB">
                Filtri</span></b-button> -->
            <!-- <div class="ml-1 mr-1">{{ this.prezzoTxt }} <span v-if="this.prezzoTxt != ''"><br></span>{{ this.carTxt }}</div>
           
            <b-button size="sm" class="my-1 my-sm-0 buttonNB" @click="cercaProdotto(prodotto)"><span size="sm"
                class="buttonNB">Cerca</span></b-button> -->
          </b-nav-form>
      ...
      <b-form>
            ...
            <nav class="nav nav-pills nav-justified btn-group-toggle">
              ...
              <a class="nav-item clickable-options btn nav-link p-0" href="#">
                <label class="" v-bind:class="{ active: oroRosa }">
                  <input type="checkbox" name="options_materiale" id="oroRosa" @click="selezionaMateriale('oroRosa')">ORO
                  BIANCO
                </label>
              </a>
              <a class="nav-item clickable-options btn nav-link p-0" href="#">
        ...
        <div class="row option-section-row">
          ...
          <div class="col-md-10">
            <nav class="nav nav-pills nav-justified btn-group-toggle">
              ...
              <a class="nav-item clickable-options btn nav-link p-0" href="#">
                <label v-bind:class="{ active: oroRosa }">
                  <input type="checkbox" name="options_materiale" id="oroRosa" @click="selezionaMateriale('oroRosa')">FEHM
                </label>
              </a>
            </nav>
            ...
            <nav class="nav nav-pills nav-justified btn-group-toggle mt-1">
              ...
              <a class="nav-item clickable-options btn nav-link p-0" href="#">
                <label v-bind:class="{ active: oroRosa }">
                  <input type="checkbox" name="options_materiale" id="oroRosa" @click="selezionaMateriale('oroRosa')">PURE
                  BLACK
                </label>
              </a>
              <a class="nav-item clickable-options btn nav-link p-0" href="#">
            ...
            <nav class="nav nav-pills nav-justified btn-group-toggle mt-1">
              <a class="nav-item clickable-options btn active nav-link p-0" href="#">
                <label class="active" v-bind:class="{ active: oroTutto }">
                  <input type="checkbox" name="options_materiale" id="oroBianco" @click="selezionaMateriale('tutto')">SOUL
                  SPACES
                </label>
              </a>
        ...
        <div class="row mt-4">
          <div class="col-md-6">
            ...
            <b-button variant="" @click="resetFiltri()" style="margin-left:1em" class="btn-options-other">Reset</b-button>
          </div>
          <div class="col-md-6">
...
.btn-options-other {
  border: 1px solid #b30c0c !important;
  border-radius: 2px !important;
...
.clickable-options:last-child {
  border-left: 1px solid #b30c0c !important;
  border-right: 1px solid #b30c0c !important;
