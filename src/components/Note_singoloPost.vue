    ...
    <b-card>
      <template #header>
        <div>
          <b-icon
            icon="pencil-square"
            style="font-size: 30px; vertical-align: middle; float: left"
            @click="modificaNota(myNota)"
          ></b-icon>
          ...
          <b-icon
            icon="trash"
            style="font-size: 30px; vertical-align: middle; float: right"
            @click="eliminaNota(myNota.id)"
          ></b-icon>
        </div>
      </template>
      <b-card-text>
