  ...
  <b-modal id="modal-nuovoCliente" hide-footer :title="titoloCliente" size="xl">
    <b-form @submit="onSubmitNuovoCliente">
      ...
      <b-form-group label="Telefono:" label-for="input-telefono"
        v-if="this.$session.exists() && (this.$session.get('AUTORIZZAZIONI').numeri_telefono >= 1)">
      ...
      <b-row>
        <b-col>
          <b-form-group label="Fascia Prezzo:" label-for="input-fasciaPrezzo">
            <b-form-select id="input-fasciaPrezzo" v-model="formNuovoCliente.fasciaPrezzo"
              :options="optionsFasciaPrezzo"></b-form-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Tipologia di gioielli richiesta:" label-for="input-tipologiaRichiesta">
            <b-form-input id="input-tipologiaRichiesta" v-model="formNuovoCliente.tipologiaRichiesta"
              type="text"></b-form-input>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Misura Anello:" label-for="input-misuraAnello">
            <b-form-input id="input-misuraAnello" v-model="formNuovoCliente.misuraAnello" type="text"></b-form-input>
          </b-form-group>
        </b-col>
      ...
      <b-row>
        <b-col>
          <b-form-group label="Data di nascita:" label-for="input-dataNascita">
            <b-form-datepicker id="input-dataNascita" today-button reset-button v-model="formNuovoCliente.dataNascita"
              class="mb-2"></b-form-datepicker>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Fascia Età:" label-for="input-fasciaEta">
            <b-form-select id="input-fasciaEta" v-model="formNuovoCliente.fasciaEta"
              :options="optionsFasciaEta"></b-form-select>
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
        <b-col>
          <b-form-group label="Fonte Visita:" label-for="input-fonte">
            <model-select class="form-control" id="input-fonte" :options="optionsFonte" v-model="formNuovoCliente.fonte"
              placeholder="Seleziona la fonte"></model-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Dettaglio fonte:" label-for="input-dettaglioFonte">
            <b-form-input id="input-dettaglioFonte" v-model="formNuovoCliente.fonte_dettaglio" type="text"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <b-form-group label="Hobbies:" label-for="input-hobbies">
        <b-form-input id="input-hobbies" v-model="formNuovoCliente.hobbies" type="text"></b-form-input>
      </b-form-group>
      ...
      <b-row>
        <b-col>
          <b-form-group label="Cliente collegto (1):" label-for="input-coll1">
            <model-select id="input-coll1" class="form-control" :options="optionsClienti"
              v-model="formNuovoCliente.idCollegamento1" placeholder="Seleziona il cliente"></model-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Relazione" label-for="input-relazione1">
            <b-form-input id="input-relazione1" v-model="formNuovoCliente.relazione1" type="text"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <hr>
      <b-row>
        <b-col>
          <b-form-group label="Cliente collegto (2):" label-for="input-coll2">
            <model-select id="input-coll1" class="form-control" :options="optionsClienti"
              v-model="formNuovoCliente.idCollegamento2" placeholder="Seleziona il cliente"></model-select>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Relazione" label-for="input-relazione2">
            <b-form-input id="input-relazione2" v-model="formNuovoCliente.relazione2" type="text"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <b-form-checkbox style="margin-bottom:3em;" v-model="formNuovoCliente.tagAttivo" name="input-tag" id="input-tag"
        switch>
        TAG: <b>
          <span v-if="formNuovoCliente.tagAttivo == true"><b-icon icon="bookmarks-fill" variant="success" font-scale="1.5"
              style="margin-left:0.5em"></b-icon>SI</span>
          <span v-else><b-icon icon="bookmarks" variant="success" font-scale="1.5" style="margin-left:0.5em"></b-icon>
            NO</span>
        </b>
      </b-form-checkbox>
      <hr>
      <b-form-checkbox style="margin-bottom:3em; float:right" v-model="formNuovoCliente.isAttivo" name="input-attivo"
        id="input-attivo" switch>
        Attivo: <b>
...
export default {
  data() {
    return {
      clienti: [],
      formNuovoCliente: {
        id: 0, cognome: '', nome: '', indirizzo: '', telefono: '', email: '', sconto: 0, tipologiaRichiesta: '', fasciaPrezzo: 'Tutto', hobbies: '',
        dataNascita: null, note: '', attivo: 1, idCollegamento1: null, idCollegamento2: null, relazione1: '', relazione2: '', isAttivo: true, tagAttivo: false, misuraAnello: '', fasciaEta: '', fonte: '', fonte_dettaglio: ''
      },
      titoloCliente: '',
      ...
      optionsFasciaEta: [{ value: "18-35", text: "18-35" }, { value: "36-44", text: "36-44" }, { value: "45-60", text: "45-60" }, { value: "60+", text: "60+" }],
      optionsFasciaPrezzo: [{ value: "Tutto", text: "Tutto" }, { value: "<500", text: "<500" }, { value: "500-1000", text: "500-1000" }, { value: "1000-2000", text: "1000-2000" }, { value: "2000-3000", text: "2000-3000" }
        , { value: "3000-6000", text: "3000-6000" }, { value: ">6000", text: ">6000" }]
    };
  },
  components: {
    ModelSelect,
  ...
  methods: {
    ...
    onSubmitNuovoCliente() {
      ...
      this.formNuovoCliente.tagAttivo = (this.formNuovoCliente.tagAttivo == true) ? 1 : 0;
