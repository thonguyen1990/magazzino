<template>
  ...
  <form >
    <div class="form-group">
      ...
      <model-select class="form-control"   :options="optionsClienti" v-model="cliente" placeholder="Seleziona il cliente"></model-select>
    </div>

    <div class="form-group">
    <div class="align-left"><label>PRODOTTO 1 </label></div>
    <model-select class="form-control"   :options="optionsProdotti" v-model="prodotto1"
    placeholder="Seleziona il prodotto"></model-select>
    </div>
    <div class="form-group">
    <div class="align-left"><label>PRODOTTO 2 </label></div>
    <model-select class="form-control"   :options="optionsProdotti" v-model="prodotto2"
    placeholder="Seleziona il prodotto"></model-select>
    </div>
    <div class="form-group">
    <div class="align-left"><label>PRODOTTO 3 </label></div>
    <model-select class="form-control"   :options="optionsProdotti" v-model="prodotto3"
    placeholder="Seleziona il prodotto"></model-select>
    </div>
<div class="form-group">
  <div class="container">
  ...
  <!--<b-form-input id="dataVendita" name="dataVendita" v-model="dataVendita"></b-form-input>-->
  <div class="align-left"><date-picker :lang="lang"  :default-value="dataVendita"	v-model="dataVendita" valueType="DD/MM/YYYY" ></date-picker> {{dataVendita}}</div>
</div>
   <div class="col-8"><textarea   placeholder="Inserisci una nota..." class="form-control" id="note" v-model="note" rows="3"></textarea></div>
</div>
</div>
</div>
